...
export const metadata: Metadata = {
  title: 'Weather · Portrait',
  description: 'A live 480 by 800 pixel four-level grayscale weather dashboard for portrait e-paper displays.',
  openGraph: { title: 'Weather · Portrait', description: 'Live portrait weather dashboard for e-paper.', images: [] },
  twitter: { card: 'summary', title: 'Weather · Portrait', description: 'Live portrait weather dashboard for e-paper.', images: [] },
};
...
export default async function PortraitWeather({ searchParams }: { searchParams: Promise<{ city?: string | string[] }> }) {
